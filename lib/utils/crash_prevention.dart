...
class CrashPrevention {
  ...
  static void initialize() {
    ...
    try {
      ...
      _isInitialized = true;
      AppLogger.info('Crash prevention initialized', tag: 'CrashPrevention');
    } catch (e) {
      AppLogger.error(
  ...
  static void _setupPlatformCrashHandlers() {
    try {
      ...
      AppLogger.log('Failed to setup platform crash handlers: $e'); // Fallback to print
      AppLogger.error(
  ...
  static void _checkMemoryUsage() {
    try {
      ...
      if (kDebugMode) {
        AppLogger.debug('Memory check performed', tag: 'CrashPrevention');
      }
    } catch (e) {
      AppLogger.error('Memory check failed', tag: 'CrashPrevention', error: e);
    }
  }
  ...
  static void dispose() {
    try {
      ...
      AppLogger.info('Crash prevention disposed', tag: 'CrashPrevention');
    } catch (e) {
      AppLogger.error(
