...
class TransferMoneyScanQrCodeScreen extends StatefulWidget {
  const TransferMoneyScanQrCodeScreen({Key? key}) : super(key: key);

  @override
  TransferMoneyScanQrCodeScreenState createState() =>
      TransferMoneyScanQrCodeScreenState();
}
