...
class ConfirmTransferMoneyScreen extends StatelessWidget {
  ConfirmTransferMoneyScreen({Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  Strings.transferMoneyConfirm.tr,
  ...
  _nextButton(BuildContext context, TransferMoneyController controller) {
    return Container(
