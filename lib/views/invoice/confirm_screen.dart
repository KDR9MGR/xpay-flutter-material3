...
class ConfirmInvoiceScreen extends StatelessWidget {
  ConfirmInvoiceScreen({super.key});
  ...
  Padding _bodyWidget(BuildContext context, InvoiceController controller) {
    return Padding(
  ...
  Container _nextButton(BuildContext context, InvoiceController controller) {
    return Container(
