...
import 'package:xpay/controller/money_out_controller.dart';
...
class ConfirmMoneyOutScreen extends StatelessWidget {
  ConfirmMoneyOutScreen({super.key});
  ...
  Padding _bodyWidget(BuildContext context, MoneyOutController controller) {
    return Padding(
  ...
  Container _nextButton(BuildContext context, MoneyOutController controller) {
    return Container(
