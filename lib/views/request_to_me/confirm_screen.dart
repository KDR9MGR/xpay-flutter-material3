...
import 'package:xpay/controller/request_to_me_controller.dart';
...
class ConfirmRequestToMeScreen extends StatelessWidget {
  ...
  Padding _bodyWidget(BuildContext context, RequestToMeController controller) {
    return Padding(
        ...
        children: [
          PrimaryButton(
            ...
            onPressed: () {
              ...
              Get.delete<RequestToMeController>();
            },
          ),
          SizedBox(height: Dimensions.heightSize * 2),
        ],
