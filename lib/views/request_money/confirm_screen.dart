...
import 'package:xpay/controller/request_controller.dart';
...
class ConfirmRequestMoneyScreen extends StatelessWidget {
  ConfirmRequestMoneyScreen({Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  Strings.requestMoneyConfirm.tr,
  ...
  _nextButton(BuildContext context, RequestMoneyController controller) {
    return Container(
