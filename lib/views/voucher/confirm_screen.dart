...
class ConfirmCreateVoucherOutScreen extends StatelessWidget {
  ConfirmCreateVoucherOutScreen({Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  Strings.voucherCreateConfirm.tr,
  ...
  _nextButton(BuildContext context, CreateVoucherController controller) {
    return Container(
      ...
      child: Column(
        children: [
          PrimaryButton(
            ...
            onPressed: () {
              controller.navigateToRedeemVoucherScreen();
            },
          ),
          SizedBox(
            height: Dimensions.heightSize * 2,
