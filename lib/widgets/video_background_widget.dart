...
class SuperFastAnimatedBackground extends StatefulWidget {
  ...
  @override
  State<SuperFastAnimatedBackground> createState() =>
      _SuperFastAnimatedBackgroundState();
}

class _SuperFastAnimatedBackgroundState
    extends State<SuperFastAnimatedBackground>
...
class YouTubeVideoWidget extends StatefulWidget {
  ...
  const YouTubeVideoWidget({super.key, this.height = 200, this.borderRadius});
